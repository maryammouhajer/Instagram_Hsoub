...
Route::middleware(['auth:sanctum', 'verified', 'language'])->group(function () {
    ...
    Route::get('/followers', function () {
        return view('followers',['profile' => auth()->user(), 'followers'=>auth()->user()->followers()->paginate(10)]);
    })->name('followers');
    
    Route::get('/following', function () {
        return view('following',['profile' => auth()->user(), 'following'=>auth()->user()->follows()->paginate(10)]);
    })->name('following');
